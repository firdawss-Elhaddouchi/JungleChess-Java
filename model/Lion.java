...
public class Lion extends Animal{
	public Lion(int player, Position position) {
        super(7, player, position,"L");
    }

	@Override
	public boolean canMoveTo(Position to, Arena arena,  List<Animal> animals) { // Renamed board to animals
